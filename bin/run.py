...
def prepare_env(args):
    ...
    call(["rm -rf *.hlt; rm -rf replays/*.hlt; rm -rf replays-readable/*.hlt; mkdir -p replays;"], shell=True)
...
def main():
    ...
    parser.add_argument('--round', type=int, default=1, help="Round index (1, 2, or 3), default 3")
